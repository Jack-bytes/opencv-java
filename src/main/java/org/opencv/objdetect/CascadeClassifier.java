...
public class CascadeClassifier {
    ...
    public void detectMultiScale(Mat image, MatOfRect objects, double scaleFactor, int minNeighbors, int flags, Size minSize) {
        detectMultiScale_1(nativeObj, image.nativeObj, objects.nativeObj, scaleFactor, minNeighbors, flags, minSize.width, minSize.height);
    }
    ...
    public void detectMultiScale(Mat image, MatOfRect objects, double scaleFactor, int minNeighbors, int flags) {
        detectMultiScale_2(nativeObj, image.nativeObj, objects.nativeObj, scaleFactor, minNeighbors, flags);
    }
    ...
    public void detectMultiScale(Mat image, MatOfRect objects, double scaleFactor, int minNeighbors) {
        detectMultiScale_3(nativeObj, image.nativeObj, objects.nativeObj, scaleFactor, minNeighbors);
    }
    ...
    public void detectMultiScale(Mat image, MatOfRect objects, double scaleFactor) {
        detectMultiScale_4(nativeObj, image.nativeObj, objects.nativeObj, scaleFactor);
    }
    ...
    public void detectMultiScale(Mat image, MatOfRect objects) {
        detectMultiScale_5(nativeObj, image.nativeObj, objects.nativeObj);
    }
    ...
    public void detectMultiScale2(Mat image, MatOfRect objects, MatOfInt numDetections, double scaleFactor, int minNeighbors, int flags, Size minSize) {
        detectMultiScale2_1(nativeObj, image.nativeObj, objects.nativeObj, numDetections.nativeObj, scaleFactor, minNeighbors, flags, minSize.width, minSize.height);
    }
    ...
    public void detectMultiScale2(Mat image, MatOfRect objects, MatOfInt numDetections, double scaleFactor, int minNeighbors, int flags) {
        detectMultiScale2_2(nativeObj, image.nativeObj, objects.nativeObj, numDetections.nativeObj, scaleFactor, minNeighbors, flags);
    }
    ...
    public void detectMultiScale2(Mat image, MatOfRect objects, MatOfInt numDetections, double scaleFactor, int minNeighbors) {
        detectMultiScale2_3(nativeObj, image.nativeObj, objects.nativeObj, numDetections.nativeObj, scaleFactor, minNeighbors);
    }
    ...
    public void detectMultiScale2(Mat image, MatOfRect objects, MatOfInt numDetections, double scaleFactor) {
        detectMultiScale2_4(nativeObj, image.nativeObj, objects.nativeObj, numDetections.nativeObj, scaleFactor);
    }
    ...
    public void detectMultiScale2(Mat image, MatOfRect objects, MatOfInt numDetections) {
        detectMultiScale2_5(nativeObj, image.nativeObj, objects.nativeObj, numDetections.nativeObj);
    }
    ...
    public void detectMultiScale3(Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights, double scaleFactor, int minNeighbors, int flags, Size minSize, Size maxSize) {
        detectMultiScale3_1(nativeObj, image.nativeObj, objects.nativeObj, rejectLevels.nativeObj, levelWeights.nativeObj, scaleFactor, minNeighbors, flags, minSize.width, minSize.height, maxSize.width, maxSize.height);
    }
    ...
    public void detectMultiScale3(Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights, double scaleFactor, int minNeighbors, int flags, Size minSize) {
        detectMultiScale3_2(nativeObj, image.nativeObj, objects.nativeObj, rejectLevels.nativeObj, levelWeights.nativeObj, scaleFactor, minNeighbors, flags, minSize.width, minSize.height);
    }
    ...
    public void detectMultiScale3(Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights, double scaleFactor, int minNeighbors, int flags) {
        detectMultiScale3_3(nativeObj, image.nativeObj, objects.nativeObj, rejectLevels.nativeObj, levelWeights.nativeObj, scaleFactor, minNeighbors, flags);
    }
    ...
    public void detectMultiScale3(Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights, double scaleFactor, int minNeighbors) {
        detectMultiScale3_4(nativeObj, image.nativeObj, objects.nativeObj, rejectLevels.nativeObj, levelWeights.nativeObj, scaleFactor, minNeighbors);
    }
    ...
    public void detectMultiScale3(Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights, double scaleFactor) {
        detectMultiScale3_5(nativeObj, image.nativeObj, objects.nativeObj, rejectLevels.nativeObj, levelWeights.nativeObj, scaleFactor);
    }
    ...
    public void detectMultiScale3(Mat image, MatOfRect objects, MatOfInt rejectLevels, MatOfDouble levelWeights) {
        detectMultiScale3_6(nativeObj, image.nativeObj, objects.nativeObj, rejectLevels.nativeObj, levelWeights.nativeObj);
    }
