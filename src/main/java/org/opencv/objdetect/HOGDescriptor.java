...
public class HOGDescriptor {
    ...
    public void compute(Mat img, MatOfFloat descriptors, Size winStride, Size padding) {
        compute_1(nativeObj, img.nativeObj, descriptors.nativeObj, winStride.width, winStride.height, padding.width, padding.height);
    }
    ...
    public void compute(Mat img, MatOfFloat descriptors, Size winStride) {
        compute_2(nativeObj, img.nativeObj, descriptors.nativeObj, winStride.width, winStride.height);
    }
    ...
    public void compute(Mat img, MatOfFloat descriptors) {
        compute_3(nativeObj, img.nativeObj, descriptors.nativeObj);
    }
    ...
    public void detect(Mat img, MatOfPoint foundLocations, MatOfDouble weights, double hitThreshold, Size winStride, Size padding) {
        detect_1(nativeObj, img.nativeObj, foundLocations.nativeObj, weights.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height);
    }
    ...
    public void detect(Mat img, MatOfPoint foundLocations, MatOfDouble weights, double hitThreshold, Size winStride) {
        detect_2(nativeObj, img.nativeObj, foundLocations.nativeObj, weights.nativeObj, hitThreshold, winStride.width, winStride.height);
    }
    ...
    public void detect(Mat img, MatOfPoint foundLocations, MatOfDouble weights, double hitThreshold) {
        detect_3(nativeObj, img.nativeObj, foundLocations.nativeObj, weights.nativeObj, hitThreshold);
    }
    ...
    public void detect(Mat img, MatOfPoint foundLocations, MatOfDouble weights) {
        detect_4(nativeObj, img.nativeObj, foundLocations.nativeObj, weights.nativeObj);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights, double hitThreshold, Size winStride, Size padding, double scale, double finalThreshold) {
        detectMultiScale_1(nativeObj, img.nativeObj, foundLocations.nativeObj, foundWeights.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height, scale, finalThreshold);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights, double hitThreshold, Size winStride, Size padding, double scale) {
        detectMultiScale_2(nativeObj, img.nativeObj, foundLocations.nativeObj, foundWeights.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height, scale);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights, double hitThreshold, Size winStride, Size padding) {
        detectMultiScale_3(nativeObj, img.nativeObj, foundLocations.nativeObj, foundWeights.nativeObj, hitThreshold, winStride.width, winStride.height, padding.width, padding.height);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights, double hitThreshold, Size winStride) {
        detectMultiScale_4(nativeObj, img.nativeObj, foundLocations.nativeObj, foundWeights.nativeObj, hitThreshold, winStride.width, winStride.height);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights, double hitThreshold) {
        detectMultiScale_5(nativeObj, img.nativeObj, foundLocations.nativeObj, foundWeights.nativeObj, hitThreshold);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights) {
        detectMultiScale_6(nativeObj, img.nativeObj, foundLocations.nativeObj, foundWeights.nativeObj);
    }
